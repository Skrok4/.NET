                ...
                .ConfigureWebHostDefaults(webBuilder =>
                {
                    webBuilder.ConfigureServices((hostContext, services) =>
                    {
                        ...
                        services.AddAuthentication(JwtBearerDefaults.AuthenticationScheme)
                            .AddJwtBearer(options =>
                            {
                                options.TokenValidationParameters = new TokenValidationParameters
                                {
                                    ...
                                    IssuerSigningKey = new SymmetricSecurityKey(Encoding.UTF8.GetBytes(s: hostContext.Configuration["TokenKey"]))
                                };
                            });
                        ...
                        services.AddSwaggerGen(e =>
                        {
                            ...
                            e.SwaggerDoc("v2", new OpenApiInfo { Title = "Fitness Tracking API", Version = "v2" });
                            e.SwaggerDoc("v3", new OpenApiInfo { Title = "Fitness Tracking API", Version = "v3" });
                    ...
                    .Configure((hostContext, app) =>
                    {
                        ...
                        app.UseSwaggerUI(e =>
                        {
                            ...
                            e.SwaggerEndpoint("/swagger/v2/swagger.json", "Fitness Tracking API V2");
                            e.SwaggerEndpoint("/swagger/v3/swagger.json", "Fitness Tracking API V3");
